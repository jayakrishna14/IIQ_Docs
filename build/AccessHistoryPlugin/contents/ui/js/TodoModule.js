...
var todoModule = angular.module('TodoList', ['ui.bootstrap', 'sailpoint.i18n']);
 ...
 */
todoModule.controller('TodoController', function(todoService, pageConfigService, $q, $uibModal, $translate) {
...
todoModule.service('todoService', function($http) {
    ...
    return {
        ...
        getTodos: function() {
            ...
            return $http.get(TODOS_URL).then(function(response) {
        ...
        getTodo: function(id) {
            ...
            return $http.get(TODO_URL).then(function(response) {
        ...
        addTodo: function(name, time, notes) {
            ...
            return $http.post(TODOS_URL, payload).then(function(response) {
                return response.data;
            });
        },
        ...
        completeTodo: function(id) {
            ...
            return $http.post(TODO_URL, null).then(function(result) {
                return {};
            });
        },
        ...
        deleteTodo: function(id) {
            ...
            return $http.delete(TODO_URL).then(function(result) {
                return {};
            });
        }
...
todoModule.service('flaggedUserService', function($http) {
    ...
    return {
        ...
        getFlaggedUsers: function() {
            ...
            return $http.get(FLAGGED_USERS_URL).then(function(response) {
                return response.data.objects;
            });
        }
